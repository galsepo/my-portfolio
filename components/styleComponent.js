...
export const buttonBlue = `relative bottom-4 items-center drop-shadow-md text-center bg-gradient-to-r from-cyan-400 to-blue-600 text-white px-4 py-2 rounded-md hover:scale-110 duration-200  active:bg-blue-700 focus:outline-none focus:ring focus:ring-blue-300`